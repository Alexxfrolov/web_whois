...
module Mobile
  class Application < Hanami::Application
    configure do
      ...
      #
      # sessions :cookie, secret: ENV['MOBILE_SESSIONS_SECRET']
      ...
      #
      layout :application # It will load Mobile::Views::ApplicationLayout
      ...
      # Configure the code that will yield each time Mobile::Action is included
      ...
      # Configure the code that will yield each time Mobile::View is included
      # This is useful for sharing common functionality
      #
      # See: http://www.rubydoc.info/gems/hanami-view#Configuration
      view.prepare do
        include Hanami::Helpers
        include Mobile::Assets::Helpers
      end
    end
